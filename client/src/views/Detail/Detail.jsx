      ...
      >
        <div className={`${style.detailItemContainer} detailCountry`}>
          <div className={style.detailItem}>
            ...
            <span className={`${style.detailValue} id`}>{id}</span>
          </div>
          <div className={style.detailItem}>
            <span className={style.detailLabel}>Name: </span>
            <span className={`${style.detailValue} name`}>{country.name}</span>
          </div>
          <div className={style.detailItem}>
            <span className={style.detailLabel}>Continent: </span>
            <span className={`${style.detailValue} continent`}>{country.continent}</span>
          </div>
          <div className={style.detailItem}>
            <span className={style.detailLabel}>Capital: </span>
            <span className={`${style.detailValue} capital`}>{country.capital}</span>
          </div>
          <div className={style.detailItem}>
            <span className={style.detailLabel}>Subregion: </span>
            <span className={`${style.detailValue} subregion`}>{country?.subregion}</span>
          </div>
          <div className={style.detailItem}>
            <span className={style.detailLabel}>Area: </span>
            <span className={`${style.detailValue} area`}>{country?.area}</span>
          </div>
          <div className={style.detailItem}>
            <span className={style.detailLabel}>Population: </span>
            <span className={`${style.detailValue} population`}>{country.population}</span>
          </div>
        </div>
      </div>
